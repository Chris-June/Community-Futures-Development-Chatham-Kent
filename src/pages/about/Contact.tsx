...
export default function Contact() {
  ...
  return (
    <div className="bg-gradient-to-b from-background to-primary-50 dark:from-background dark:to-background/95">
      ...
      <div className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-background to-primary-50 dark:from-background dark:to-primary-950 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            >
              <div className="group relative rounded-3xl p-8 h-full transition-all duration-300">
                {/* Glassmorphism Card Background */}
                <div className="absolute inset-0 rounded-3xl bg-card/70 dark:bg-card/60 backdrop-blur-md border border-border/60 dark:border-border/40 shadow-lg group-hover:shadow-xl transition-all duration-300" />
                <h3 className="relative z-10 text-xl font-bold text-foreground mb-6">
                  Get in Touch
                </h3>
                    ...
                    <div className="ml-4">
                      ...
                      <dd className="mt-1 text-base">
                        <a
                          ...
                          className="text-foreground hover:text-primary-600 dark:hover:text-primary-400 transition-colors break-all"
                        >
                ...
                <div className="relative z-10 mt-10 pt-10 border-t border-border">
                  <h4 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-4">
                    Follow Us
                  </h4>
                  <div className="flex space-x-4">
                    <a href="#" className="text-muted-foreground hover:text-primary-600 dark:hover:text-primary-400">
            ...
            >
              <div className="group relative rounded-3xl p-8 h-full transition-all duration-300">
                {/* Glassmorphism Card Background */}
                <div className="absolute inset-0 rounded-3xl bg-card/70 dark:bg-card/60 backdrop-blur-md border border-border/60 dark:border-border/40 shadow-lg group-hover:shadow-xl transition-all duration-300" />
                <h3 className="relative z-10 text-2xl font-bold text-foreground mb-2">
                  Send Us a Message
                </h3>
                <p className="relative z-10 text-muted-foreground mb-8">
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-border rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 bg-background text-foreground"
